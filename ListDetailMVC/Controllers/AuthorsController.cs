...
namespace ListDetailMVC.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,PerfectureId")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,PerfectureId")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
